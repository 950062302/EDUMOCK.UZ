    ...
    <div className="space-y-6 mt-12 max-w-[600px]">
      <div className="p-5 rounded-xl shadow-lg bg-lime-50 border border-lime-300 animated-card" style={{ animationDelay: '1.1s' }}>
        <p className="text-xl font-extrabold text-lime-700">
          {t("landing_page.slogan")} {/* Tarjima qilingan matn */}
        </p>
      </div>
      ...
      <div className="bg-white p-5 rounded-xl shadow-xl border border-gray-200 animated-card" style={{ animationDelay: '1.3s' }}>
        <h2 className="text-xl font-bold text-gray-900 mb-3 flex items-center">
          ...
          {t("landing_page.contact_us")} {/* Tarjima qilingan matn */}
        </h2>
        <div className="space-y-2 text-gray-700 pl-3">
          <p className="flex items-center text-lg">
            ...
            <a href="tel:+998772077117" className="text-gray-900 font-semibold font-mono">{t("landing_page.phone_number")}</a> {/* Tarjima qilingan matn */}
          </p>
          <p className="flex items-center text-lg">
            <span className="text-lime-500 mr-2">
              <Upload className="h-5 w-5" />
            </span>
            <a href="https://t.me/aero_one" target="_blank" rel="noopener noreferrer" className="text-gray-900 font-semibold font-mono">{t("landing_page.telegram_username")}</a> {/* Tarjima qilingan matn */}
          </p>
        </div>
      </div>
    </div>
